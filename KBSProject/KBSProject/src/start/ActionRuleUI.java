...
public class ActionRuleUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        decisionPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Decision Attribute Details", 0, 0, new java.awt.Font("Times New Roman", 1, 20)));
     decisionPanel.setBackground(Color.white);
        decisionValueFromLabel.setText("Value From");
        decisionValueToLabel.setText("Value To");
        ...
        stablePanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Stable Attribute Details", 0, 0, new java.awt.Font("Times New Roman", 1, 20)));
stablePanel.setBackground(Color.white);
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) throws IOException {
        ...
        ActionRule.SetAttributeNames(allAttributes1);
        ActionRule.SetDataFilePath(jLabel5.getText().toString());
        ActionRule.SetSupportThreshold(Integer.parseInt(support.getText().toString()));
        ActionRule.SetConfidenceThreshold(Integer.parseInt(confidence.getText().toString()));
        ActionRule.SetDecisionAttribute(decisionColumn.getSelectedItem().toString().split("-")[1]);
        ActionRule.SetDecisionFromValue(decisionValueFrom.getText().toString());
        ActionRule.SetDecisionToValue(decisionValueTo.getText().toString());
        ActionRule.SetStableAttribute(stableAttributes);
